...
class DataViewHandle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    : statusRequest == StatusRequest.taskFailure        ? Container(color: Colors.white, child: Center(child: Lottie.asset(ImageUse.noData, width: Get.width * (300 / 375.0), height: Get.height * (300 / 812.0),),)) 
    : widget;
  }
}
...
class ReqViewHandle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return 
      ...
      statusRequest == StatusRequest.loading            ? Center(child: Lottie.asset(ImageUse.loading, width: Get.width * (250 / 375.0), height: Get.height * (250 / 812.0),),)
    : statusRequest == StatusRequest.connectionFailure  ? Center(child: Lottie.asset(ImageUse.noInternet, width: Get.width * (250 / 375.0), height: Get.height * (250 / 812.0),),) 
    : statusRequest == StatusRequest.taskFailure        ? Center(child: Lottie.asset(ImageUse.noData, width: Get.width * (250 / 375.0), height: Get.height * (250 / 812.0),),) 
    : widget;
  }
}